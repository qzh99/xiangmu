...
if(col){
//var _69f=_69c[_69e];
var _69f = eval("_69c['" + _69e.replace(/\./g, "']['") + "']");	
...
if(typeof(_69f)=="string"){
	cc.push(_69f.replace(/</ig,'$lt;').replace(/>/ig,'&gt;'));
}else{
	cc.push(_69f);
}
}
...
$.extend($.fn.layout.methods, {
	...
	unFull : function (jq) {
		return jq.each(function () {
			...
			center.parent().css('z-index', 'inherit'); //继承
			center.panel('restore'); //恢复、复原
...
function full(){
	$("body").layout("full");
	$("#content_info").addClass("panel-fit");
}
