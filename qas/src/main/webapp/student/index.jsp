...
<body id="body"  class="easyui-layout" >
	<div data-options="region:'north',border:false" style="height:100px;background:#B3DFDA;">
		...
		<div class="navy_header">
			<div>
				<input id="studentSno" type="hidden" value='${sessionScope.currentuser.sNo}'/>
				<p>当前用户: <span id="index_loginuser">${sessionScope.currentuser.sName}</span></p>
		...
		<ul id="index_menu_tree" class="easyui-tree">  
		    <li>  
		        ...
		        <ul>  
		            ...
		            <li id="studentSelectCourse">选课</li>  
		            <li>  
		                <span>成绩查询</span>  
		              	<ul>
				            <li id="studentAppraise">  
				                <span>量化考核成绩</span>  
				            </li> 
				             <li id="studentScore">  
				                <span>学科成绩</span>  
