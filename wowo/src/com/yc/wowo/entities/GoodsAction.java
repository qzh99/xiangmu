...
public class GoodsAction implements Serializable{
	...
	private static final long serialVersionUID = 4223800171609203235L;
	...
	public String toString(){
		return "GoodsAction [gaid="+ gaid + ",gid="+ gid + ",aprice="+ aprice + ",personnum="+ personnum 
				+ ",title="+ title + ",startdate="+ startdate + ",startend="+ startend + ",tishi="+ tishi 
				+ ",content="+ content + ",gname="+ gname + ",sname="+ sname + ",aname="+ aname + 
