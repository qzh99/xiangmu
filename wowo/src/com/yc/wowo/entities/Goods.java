...
public class Goods implements Serializable {
	...
	private static final long serialVersionUID = 4869885045793853436L;
	private Integer gid;
	...
	public String toString(){
		return "Goods [gid="+ gid + ",gname"+ gname + ",des="+ des + ",price="+ price 
				+ ",pic="+ pic + ",status="+ status + ",spid="+ spid + ",sname="+ sname + 
				",aname="+ aname + ",flag="+ flag + ",mark="+ mark + ",temp="+ temp + "]";
	}
...
//		}
	...
	public Goods(Integer gid, String gname, String des, double price,
			...
			String aname, String flag, String mark, String temp) {
		super();
		this.gid = gid;
		this.gname = gname;
		this.des = des;
