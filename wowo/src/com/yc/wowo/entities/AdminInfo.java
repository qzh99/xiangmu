...
public class AdminInfo implements Serializable {
	private static final long serialVersionUID = 1358319879927427038L;
	...
	public String toString(){
		return "IAdminInfo [aid="+ aid + ",aname=" +aname +",pwd=" +pwd +",rid=" +rid +",emali=" +email 
				+",tel=" +tel +",photo="+ photo + ",status="+ status + ",mark="+ mark + ",rname="+ rname + "]";
	}
