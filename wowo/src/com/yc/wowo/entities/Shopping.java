...
public class Shopping implements Serializable {
	...
	private static final long serialVersionUID = -1653115117648692909L;
	...
	public String toString(){
		return "Shopping [spid="+ spid + ",sname="+ sname + ",aid="+ aid + ",tid="+ tid + 
				",prov="+ prov + ",city="+ city + ",area="+ area + ",points="+ points + 
				",tel="+ tel + ",info="+ info + ",status="+ status + ",tname="+ tname + 
